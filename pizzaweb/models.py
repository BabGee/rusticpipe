...
RESTAURANTS = ((0, 'Rustic Pipe Bistro'),(1, 'Lemon Lounge'))
...
class Product(models.Model):
    image = models.ImageField(default='pizza.jpg', upload_to='product_pics')
    ...
    restaurant = models.IntegerField(choices=RESTAURANTS, default=0)
